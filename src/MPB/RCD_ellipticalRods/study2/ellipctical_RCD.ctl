; validation runs:
; w=0.480 h=0.480 inside-index=1 outside-index=2.4
...
;;   (get_components rod-center)
  ...
  ;; We use multiple copies of the tetra instead of relying on point-in-periodic-object? since it does not work properly when applied separately to each component of the "intersection objects".
  (get_components rod0)
  (get_components rod1)
  (get_components rod2)
  (get_components rod3)

  (get_components (shift-geometric-object rod0 (vector3 1 0 0)))
  (get_components (shift-geometric-object rod1 (vector3 1 0 0)))
  (get_components (shift-geometric-object rod2 (vector3 1 0 0)))
  (get_components (shift-geometric-object rod3 (vector3 1 0 0)))

  (get_components (shift-geometric-object rod0 (vector3 0 1 0)))
  (get_components (shift-geometric-object rod1 (vector3 0 1 0)))
  (get_components (shift-geometric-object rod2 (vector3 0 1 0)))
  (get_components (shift-geometric-object rod3 (vector3 0 1 0)))

  (get_components (shift-geometric-object rod0 (vector3 0 0 1)))
  (get_components (shift-geometric-object rod1 (vector3 0 0 1)))
  (get_components (shift-geometric-object rod2 (vector3 0 0 1)))
  (get_components (shift-geometric-object rod3 (vector3 0 0 1)))

  (get_components (shift-geometric-object rod0 (vector3 0 1 1)))
  (get_components (shift-geometric-object rod1 (vector3 0 1 1)))
  (get_components (shift-geometric-object rod2 (vector3 0 1 1)))
  (get_components (shift-geometric-object rod3 (vector3 0 1 1)))

  (get_components (shift-geometric-object rod0 (vector3 1 0 1)))
  (get_components (shift-geometric-object rod1 (vector3 1 0 1)))
  (get_components (shift-geometric-object rod2 (vector3 1 0 1)))
  (get_components (shift-geometric-object rod3 (vector3 1 0 1)))

  (get_components (shift-geometric-object rod0 (vector3 1 1 0)))
  (get_components (shift-geometric-object rod1 (vector3 1 1 0)))
  (get_components (shift-geometric-object rod2 (vector3 1 1 0)))
  (get_components (shift-geometric-object rod3 (vector3 1 1 0)))

  (get_components (shift-geometric-object rod0 (vector3 1 1 1)))
  (get_components (shift-geometric-object rod1 (vector3 1 1 1)))
  (get_components (shift-geometric-object rod2 (vector3 1 1 1)))
  (get_components (shift-geometric-object rod3 (vector3 1 1 1)))
...
;;           (point-in-periodic-object? point-lattice (list-ref rod 1))
          (point-in-object? point-lattice (list-ref rod 0))
          (point-in-object? point-lattice (list-ref rod 1))
        )
        (set! inside true)
      )
    )
