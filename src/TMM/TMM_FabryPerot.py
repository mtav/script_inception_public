...
def FabryPerotTest():
  ...
  for idx, cur_incidence_angle_deg in enumerate(incidence_angle):
    ...
    reflectance, transmittance = FabryPerot(lam_vac, n_outside, n_inside, thickness, cur_incidence_angle_rad)
    ...
    for lam_vac_current in lam_vac:
      result = coh_tmm('s', n_list, d_list, cur_incidence_angle_rad, lam_vac_current)
