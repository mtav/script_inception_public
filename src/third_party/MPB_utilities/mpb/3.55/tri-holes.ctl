...
(define-param kz 0.5) ; use non-zero kz to consider vertical propagation
...
(define-param ref 3.3) ; the dielectric constant of the background
(define-param r 0.45) ; the hole radius

(set! default-material (make dielectric (index ref)))
