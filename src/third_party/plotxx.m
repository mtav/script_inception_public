function [ax, hl1, hl2] = plotxx(x1, y1, x2, y2, xlabels, ylabels)
  ...
  %
  % Then, if you want to add more lines to this plot, use the low-level
  % LINE command together with the 'Parent' property.
  %
  % h3 = line(x3,y3,'Color','k','Parent',ax(1));
  % h4 = line(x4,y4,'Color','r','Parent',ax(2));
