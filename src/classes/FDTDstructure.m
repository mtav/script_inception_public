% structure containing data necessary for FDTD simulations
function sim = FDTDstructure()
  ...
  sim.cylinder_list =  [];
  sim.rotation_list =  [];
  sim.geometry_object_list = {}; % cell(); Matlab/Octave cell() call behaves differently... :/
