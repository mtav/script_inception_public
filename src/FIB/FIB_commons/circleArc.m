function [dwell_vector,X,Y] = circleSection(beamCurrent, res, dwell, circleCentro2D_mum, circleRadius_mum, rinner_mum, alpha_start, alpha_end)
  ...
  Ncircles = floor(((circleRadius_mum-rinner_mum)/res)/BeamStep_X_pxl)
  ...
  for m = 1:Ncircles
    %m = Ncircles
    currentRadius_pxl =  rinner_pxl + m*BeamStep_X_pxl;
    %alpha_start = 0
