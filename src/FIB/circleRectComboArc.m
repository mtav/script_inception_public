function filename_cellarray = circleRectCombo(fileBaseName, mag, dwell, rep, beamCurrent, circleCentro2D, circleRadius, rinner_mum, alpha_start, alpha_end)
  ...
  % ex: filename_cellarray = circleRectCombo('test.str', 50000, 100, 1, 70, [0,0], 2, -1, 0.25, -1); readStrFile(filename_cellarray,50000);
    ...
    % mag=10e3; filename_cellarray = circleRectComboArc('pi_8_1', mag, 480, 1, 1, [0,0], 6, 3, pi/2, pi); readStrFile(filename_cellarray,mag);
  ...
  [dwell_vector_circle_section,X_circle_section,Y_circle_section] = circleArc(beamCurrent, res, dwell, circleCentro2D, circleRadius, rinner_mum, alpha_start, alpha_end);
