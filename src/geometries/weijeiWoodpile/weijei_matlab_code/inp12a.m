...
mesh_x(1)=(0.5*a+0.5*w-13*mesh_d);
mesh_x(2)=(0.5*a-w)/3;
mesh_x(3)= w/4;
mesh_x(4)=(x_space-5*mesh_x(3))/7;

mesh_z(1)=(2.5*h-16*mesh_d)/3;
mesh_z(2)=h/5;
mesh_z(3)=(z_space-5*mesh_z(2))/7;

x_mesh_0(1:13)=mesh_d;
x_mesh_1=mesh_x(1);
...
z_mesh_0(1:16)=mesh_d;
z_mesh_1(1:3)=mesh_z(1);
z_mesh_2=repmat(kron(mesh_z(2),ones(1,5)),1,16);
